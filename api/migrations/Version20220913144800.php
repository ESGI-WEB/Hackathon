 ...
 */
final class Version20220913144800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, answer_id INT DEFAULT NULL, message TEXT NOT NULL, PRIMARY KEY(id))');
