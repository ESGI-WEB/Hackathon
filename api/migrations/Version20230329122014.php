 ...
 */
final class Version20230329122014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE content (id INT NOT NULL, author_id INT NOT NULL, name VARCHAR(100) NOT NULL, status VARCHAR(20) NOT NULL, PRIMARY KEY(id))');
